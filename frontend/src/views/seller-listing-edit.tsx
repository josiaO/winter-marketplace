...
export function SellerListingEditPage({ listingId }: { listingId: string }) {
  ...
  const processFiles = useCallback((files: FileList | File[]) => {
    const maxNew = 8 - existingImages.length - newImages.length;
    if (maxNew <= 0) {
          ...
          >
            <Card className="border-0 shadow-md shadow-black/5">
              <CardHeader className="pb-4">
                ...
                <CardDescription>
                  Update the essential details about your listing
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-3 rounded-xl border bg-muted/20 p-4">
                  <div className="flex items-start gap-3">
                    ...
                    />
                    <div>
                      <Label htmlFor="delivery-free-edit" className="cursor-pointer font-medium">
                  ...
                  {!form.watch('delivery_is_free') && (
                    <div className="space-y-2 pl-7">
                      <Label htmlFor="delivery_fee_edit">Delivery fee (TZS) *</Label>
                      <Input
          ...
          >
            <Card className="border-0 shadow-md shadow-black/5">
              <CardHeader className="pb-4">
                ...
                <CardDescription>
                  {totalImageCount}/8 images. The first image will be the primary photo.
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                {/* Preview Grid */}
                      ...
                      return (
                        <div key={`${isExisting ? 'existing' : 'new'}-${index}`} className="relative group aspect-square rounded-lg overflow-hidden bg-muted">
                          ...
                          <button
                            ...
                            onClick={() => {
                              if (isExisting) {
                                removeExistingImage(existingImages[index].id);
                              } else {
